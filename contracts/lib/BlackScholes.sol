...
library BlackScholes {
    ...
    function calculateOptionPrice(
        ...
        } else if (_optionType == IPriceCalculator.OptionType.CashOrNothingCall) {
            return
                calculateCallOptionPrice(
                    int256(_spot),
                    int256(_strike),
    ...
    function _calTrapezoidalRule(
        ...
        int256 end = _calCall(_spot, _strike, _logSigE4, _sqrtMaturity, _x1);
    ...
    function _calPut(
        ...
        int256 price = _calCall(_spot, _strike, _logSigE4, _sqrtMaturity, _volatility);
        return price - _spot + _strike;
    }

    function _calCashCall(
        int256 _logSigE4,
        int256 _sqrtMaturity,
        int256 _volatility
    ) internal pure returns (int256) {
        (, int256 d2E4) = _calD1D2(_logSigE4, _sqrtMaturity, _volatility);
        int256 nd2E8 = AdvancedMath._calcPnorm(d2E4);
        return nd2E8;
    }

    function _calCashPut(
        int256 _logSigE4,
        int256 _sqrtMaturity,
        int256 _volatility
    ) internal pure returns (int256) {
